...
public class managerLoginfragment extends Fragment {
    ...
    public void loginstart(){
        email = getView().findViewById(R.id.emailmanagerlogin);
        password = getView().findViewById(R.id.paswordmanger);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_manager_loginfragment, container, false);
    }
